...
// HMIS V3 Phase 0 — Rooms config table (belongs to Ward). Guarded; working down().
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable(TABLE, {
      ...
      type:        { type: Sequelize.ENUM('General', 'HDU', 'Private', 'Isolation'), allowNull: false, defaultValue: 'General' },
      bedCapacity: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 1 },
